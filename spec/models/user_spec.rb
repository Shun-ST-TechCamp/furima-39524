...
before do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できる場合' do
      it "nickname,passwordとpassword_confirmation,last_name_kanji,first_name_kanji,last_name_kana,first_name_kana,birth_dayが存在していれば登録できる" do
    ...
    context '新規登録できない場合' do
      ...
      it"last_name_kanjiが空では登録できない" do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name kanji can't be blank", "Last name kanji is invalid. Input full-width characters")
      end
      it"first_name_kanjiが空では登録できない" do
        @user.first_name_kanji = ''
        @user.valid?
        expect(@user.errors.full_messages).to include("First name kanji can't be blank", "First name kanji is invalid. Input full-width characters")
      end
